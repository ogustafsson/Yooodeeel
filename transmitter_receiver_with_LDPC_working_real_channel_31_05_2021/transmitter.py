...
def generate_signal_for_transmission(data_file):
    ...
    #overall_signal = np.append(chirp_signal, estimation_signal)
    #overall_signal = np.append(overall_signal, data_signal)
...
data_length = generate_signal_for_transmission("data_text.txt") #this data length is used as a global constant in receiver.py
