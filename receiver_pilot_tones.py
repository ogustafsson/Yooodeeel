...
data_length = 20736 #length of data sequence in time domain
...
def demodulate_pilot_tones(OFDM_data_symbol_block_start_location, number_of_OFDM_data_blocks, received_signal, N, L, pilot_index):
...
demodulated_data_symbols, demodulated_pilot_symbols, pilot_indices_overall = demodulate_pilot_tones(known_OFDM_symbol_block_end_location, number_of_OFDM_data_blocks, received_signal, N, L, 10)
